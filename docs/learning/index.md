...
| Testing, observability và performance | Stage 0, 8 | `QUEUED`: TEST-01 đứng sau JDK-01 |
...
JDK-01 là lượt chạy thử đầu tiên của system theo thứ tự mới: Java 21 platform baseline có evidence trước, rồi TEST-01 tạo safety net, JDK-02 chốt latest-LTS/Spring Boot decision, MIG-01 tạo schema baseline và sau đó mới re-activate SEC-01. JDK-02 có thể đóng bằng time-boxed defer rõ ràng; không tự biến thành platform upgrade khi chưa được active. Artifact của JDK-01 được tạo dần theo checkpoint:
