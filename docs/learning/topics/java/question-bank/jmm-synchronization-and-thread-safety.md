...
> Related theory: [Core theory](../theory/core/jmm-synchronization-and-thread-safety.md), [Deep-dive](../theory/deep-dives/jmm-happens-before-publication-and-locking.md) — `TEACHABLE_DRAFT`, evidence `NOT RUN`<br>
> Updated: `2026-07-26`
...
**Evidence:** [Core theory](../theory/core/jmm-synchronization-and-thread-safety.md) · [Deep-dive](../theory/deep-dives/jmm-happens-before-publication-and-locking.md); case `CON-01 NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
...
**Follow-up ladder:** Race `check-then-act` là gì? Lost update xảy ra thế nào? Immutable state giúp ở đâu?<br>
