...
> Related theory: [Core theory](../theory/core/time-partitioning-retention-and-archive.md) · [Deep-dive](../theory/deep-dives/partition-pruning-retention-detach-and-archive-recovery.md)<br>
> Updated: `2026-07-26`
...
**Evidence:** Theory [Core](../theory/core/time-partitioning-retention-and-archive.md) + [Deep-dive](../theory/deep-dives/partition-pruning-retention-detach-and-archive-recovery.md); case `DB-03 NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
