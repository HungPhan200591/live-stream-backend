...
> Related theory: `NOT CREATED`; planned target `docs/learning/topics/database/theory/core/ledger-lost-update-and-money-invariants.md`<br>
> Updated: `2026-07-26`
...
**Evidence:** Theory `NOT CREATED`; case `WAL-01 NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
