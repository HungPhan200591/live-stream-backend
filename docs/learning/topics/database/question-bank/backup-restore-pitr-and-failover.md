...
> Related theory: [Core theory](../theory/core/backup-restore-pitr-and-failover.md) · [Deep-dive](../theory/deep-dives/pitr-timeline-failover-and-restore-validation.md)<br>
> Updated: `2026-07-26`
...
**Evidence:** Theory [Core](../theory/core/backup-restore-pitr-and-failover.md) + [Deep-dive](../theory/deep-dives/pitr-timeline-failover-and-restore-validation.md); case `DR-01 NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
