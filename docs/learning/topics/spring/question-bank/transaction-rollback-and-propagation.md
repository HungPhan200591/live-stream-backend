...
> Related theory: [Core theory](../theory/core/transaction-rollback-and-propagation.md), [Deep-dive](../theory/deep-dives/transaction-propagation-isolation-and-crash-windows.md) — `TEACHABLE_DRAFT`, evidence `NOT RUN`<br>
> Updated: `2026-07-26`
...
**Evidence:** [Core theory](../theory/core/transaction-rollback-and-propagation.md) · [Deep-dive](../theory/deep-dives/transaction-propagation-isolation-and-crash-windows.md); case `TX-01 NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
...
**Evidence:** [Core theory](../theory/core/transaction-rollback-and-propagation.md) · [Deep-dive](../theory/deep-dives/transaction-propagation-isolation-and-crash-windows.md); reproducer `NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
**Self-assessment:** `UNANSWERED`
...
**Evidence:** [Core theory](../theory/core/transaction-rollback-and-propagation.md) · [Deep-dive](../theory/deep-dives/transaction-propagation-isolation-and-crash-windows.md); design `NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
**Self-assessment:** `UNANSWERED`
...
**Evidence:** [Core theory](../theory/core/transaction-rollback-and-propagation.md) · [Deep-dive](../theory/deep-dives/transaction-propagation-isolation-and-crash-windows.md); experiment `NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
**Self-assessment:** `UNANSWERED`
...
**Evidence:** [Core theory](../theory/core/transaction-rollback-and-propagation.md) · [Deep-dive](../theory/deep-dives/transaction-propagation-isolation-and-crash-windows.md); Test design `NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
**Self-assessment:** `UNANSWERED`
...
**Evidence:** [Core theory](../theory/core/transaction-rollback-and-propagation.md) · [Deep-dive](../theory/deep-dives/transaction-propagation-isolation-and-crash-windows.md); Reproducer `NOT CREATED`; experiment `NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
**Self-assessment:** `UNANSWERED`
