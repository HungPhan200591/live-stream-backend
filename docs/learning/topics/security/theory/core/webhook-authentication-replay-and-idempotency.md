# Webhook Authentication, Replay Protection và Idempotency
...
### 6.1. JSON reserialization failure
...
### 6.2. Replay trong timestamp window
...
### 6.3. Crash sau commit trước response
...
## 9. Project application và phỏng vấn
...
## 10. Tóm tắt, learner và self-check
