# Ngân hàng câu hỏi phỏng vấn Security — lộ secret, DTO theo audience và che dữ liệu trong log
...
> Related theory: [Core theory](../theory/core/secret-exposure-and-audience-boundaries.md); [Deep-dive](../theory/deep-dives/secret-rotation-redaction-and-incident-containment.md)<br>
> Updated: `2026-07-26`

Bản xem trước này không triển khai `SEC-03`, không kích hoạt case và không tạo bằng chứng. `Interview likelihood` chỉ là ước lượng trong phạm vi bảo mật REST/API của backend, không phải tỷ lệ thị trường đã đo. Mọi câu giữ `UNANSWERED`, kiểm thử `NOT RUN`.
...
**Evidence:** Theory [Core](../theory/core/secret-exposure-and-audience-boundaries.md); Deep-dive [Advanced](../theory/deep-dives/secret-rotation-redaction-and-incident-containment.md); case `SEC-03 NOT CREATED`; tests `NOT RUN`; note `NOT CREATED`.<br>
