...
| [`run-senior-java-learning`](../../.agents/skills/run-senior-java-learning/SKILL.md) | Điều phối knowledge-to-evidence với knowledge tree domain-first và contract riêng cho theory/deep-dive/question bank/case/experiment/interview note. | Bắt đầu/tiếp tục topic hoặc case, tạo preview learning pack chuẩn, chọn học gì tiếp theo, luyện Senior/Architect/Expert dựa trên project evidence. | Bug fix, feature implementation hoặc review độc lập không có learning objective. |
