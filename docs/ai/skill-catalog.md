...
| [`run-senior-java-learning`](../../.agents/skills/run-senior-java-learning/SKILL.md) | Điều phối knowledge-to-evidence với knowledge tree domain-first; question bank ưu tiên câu phổ biến theo likelihood trước khi tới project/Architect/Expert stretch. | Bắt đầu/tiếp tục topic hoặc case, tạo preview learning pack chuẩn, chọn học gì tiếp theo, luyện từ foundation thường gặp tới Senior/Architect/Expert dựa trên project evidence. | Bug fix, feature implementation hoặc review độc lập không có learning objective. |
